...
author: "Pedro Magalh??es Batista"
date: "12/10/2018"
...
1.1. And to plot some graphs: ggplot2
2. Read DATA and parsing dates
3. Grouping activities per day
...
## 1. Parsing data and plot: lubridate, dplyr to parse data
## 1.1. And to plot some graphs: ggplot2
